...
/*
var _ io.Reader = RequestHeader{}
var _ io.Writer = RequestHeader{}

func (r *RequestHeader) Read(p []byte) (n int, err error) {

}

func (r *RequestHeader) Write(p []byte) (n int, err error) {
